 ...
 */
class ZfcUserDoctrineMongoODMDocumentUserHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        if (isset($data['display_name'])) {
            ...
            $return = (string) $value;
            $this->class->reflFields['display_name']->setValue($document, $return);
            $hydratedData['display_name'] = $return;
        }
