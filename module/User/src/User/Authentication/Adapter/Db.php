...
use User\Authentication\Adapter\AdapterChainEvent as AuthEvent;
use User\Mapper\User as UserMapperInterface;
...
class Db extends AbstractAdapter implements ServiceManagerAwareInterface
{
    ...
    public function authenticate(AuthEvent $e)
    {
        ...
        var_dump($credential,$userObject->getPassword()); exit();
    ...
    {
        if (null === $this->mapper) {
            $this->mapper = $this->getServiceManager()->get('user_user_mapper');
        }
        return $this->mapper;
    }
