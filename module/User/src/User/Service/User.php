...
use User\EventManager\EventProvider;
use User\Mapper\UserInterface as UserMapperInterface;
use User\Options\UserServiceOptionsInterface;
...
class User extends EventProvider implements ServiceManagerAwareInterface
{
    ...
    public function getUserMapper()
    {
        if (null === $this->userMapper) {
            $this->userMapper = $this->getServiceManager()->get('user_user_mapper');
        }
    ...
    public function getRegisterForm()
    {
        if (null === $this->registerForm) {
            $this->registerForm = $this->getServiceManager()->get('user_register_form');
        }
    ...
    public function getChangePasswordForm()
    {
        if (null === $this->changePasswordForm) {
            $this->changePasswordForm = $this->getServiceManager()->get('user_change_password_form');
        }
    ...
    public function getFormHydrator()
    {
        if (!$this->formHydrator instanceof Hydrator\ClassMethods) {
            $this->setFormHydrator($this->getServiceManager()->get('user_register_form_hydrator'));
        }
