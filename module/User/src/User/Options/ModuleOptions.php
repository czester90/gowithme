    ...
    UserServiceOptionsInterface
{
     ...
     * @var array
     */
    protected $authAdapters = array( 100 => 'User\Authentication\Adapter\Db' );
     ...
     * @var string
     */
    protected $userEntityClass = 'User\Document\User';

    /**
     * @var string
     */
    protected $userLoginWidgetViewTemplate = '-user/user/login.phtml';
